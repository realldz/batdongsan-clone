...
import { getProvinces, getDistricts, getWards, getStreets, searchGeography, type GeographyDivision } from "@/services/geography";
                  ...
                  <div className="flex flex-col max-h-[50vh] overflow-y-auto custom-scrollbar">
                    {searchResults.map((res) => {
                      ...
                      return (
                        <div
                          key={res.id}
                          className="py-3 border-b border-gray-100 cursor-pointer hover:bg-gray-50 text-[14px] flex items-center gap-2"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full border border-gray-300 rounded-md px-3 py-2.5 appearance-none outline-none focus:border-[#2c2c2c] text-[14px] bg-white"
                      >
                  ...
                  <div>
                    ...
                    {apiDistricts.length > 0 ? (
                      ...
                      <input
                        ...
                        onChange={(event) => setSelectedAddress({ ...selectedAddress, district: event.target.value })}
                        placeholder="Nhập Quận/Huyện"
                        className="w-full border border-gray-300 rounded-md px-3 py-2.5 outline-none focus:border-[#2c2c2c] text-[14px]"
                      />
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {apiWards.length > 0 ? (
                      ...
                      <input
                        ...
                        onChange={(event) => setSelectedAddress({ ...selectedAddress, ward: event.target.value })}
                  ...
                  <div>
                    ...
                    {apiStreets.length > 0 ? (
                      ...
                      <input
                        type="text"
                        value={selectedAddress.street}
                        onChange={(event) => setSelectedAddress({ ...selectedAddress, street: event.target.value })}
                ...
                <div className="mb-8">
                  ...
                  <div className="mb-5">
                    ...
                    <div className="pl-6.5 text-[14px] text-[#2c2c2c] flex items-start gap-2">
                      ...
                      <span>{[selectedAddress.ward, selectedAddress.district, selectedAddress.province].filter(Boolean).join(", ")}</span>
                    </div>
                  </div>
                </div>
