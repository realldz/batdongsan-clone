...
import { DashboardStatsGrid } from "./_components/organisms/DashboardStatsGrid";
  ...
  return (
    <AdminPageTemplate header={header}>
      ...
      <TableShell
        ...
        description="Tin có báo cáo, người dùng bị khóa và nội dung đang chờ duyệt."
        action={<StatusBadge tone="amber">Ưu tiên cao</StatusBadge>}
      >
