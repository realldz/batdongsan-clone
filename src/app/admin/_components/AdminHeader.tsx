  ...
  return (
    <header className="h-[72px] bg-white border-b border-gray-200 shrink-0 sticky top-0 z-10 flex items-center justify-between px-5 lg:px-7">
      ...
      <div className="hidden md:flex items-center gap-3">
        ...
        <button className="h-10 px-4 rounded-full bg-gray-900 text-white text-sm font-bold hover:bg-black transition-colors flex items-center gap-2">
          <Download className="w-4 h-4" />
          Xuất báo cáo
        </button>
        <button className="w-10 h-10 rounded-full border border-gray-200 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors relative flex items-center justify-center">
          <Bell className="w-5 h-5" />
          <span className="absolute top-2.5 right-2.5 w-2 h-2 rounded-full bg-[#e03c31] border border-white" />
        </button>
        <div className="w-10 h-10 rounded-full bg-[#e03c31] text-white flex items-center justify-center font-extrabold shadow-sm">
          A
        </div>
      </div>
    </header>
