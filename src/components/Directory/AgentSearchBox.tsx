      ...
      <div className="max-w-[1140px] xl:max-w-[1240px] mx-auto px-4 lg:px-0">
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-3">
            <select className="flex-1 min-w-[140px] border border-gray-300 text-gray-600 rounded px-3 py-2 text-sm focus:outline-none focus:border-primary appearance-none bg-white">
            ...
            <button className="bg-[#e03c31] hover:bg-[#c42c23] text-white text-sm font-bold px-8 py-2 rounded transition-colors whitespace-nowrap">
              Tìm kiếm
            </button>
          </div>
